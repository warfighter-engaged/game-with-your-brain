...
void readInput()
{
  ...
  if (availableBytes >= (maxDigitalButtons + 1))
  {
    ...
    analogValue = buffer[4] / (float)9 * (float)102;

    // HOW TO WRITE TO A SPECIFIC VOLTAGE: analogWrite(51 * (desiredVoltage))
    // SOURCE: https://www.youtube.com/watch?v=9FBMVt-iFrM
